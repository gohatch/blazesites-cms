      ...
      <div className="hidden flex-1 items-center justify-center lg:flex">
        <div className="relative z-10 max-w-md px-12">
          ...
          <p className="mt-6 text-lg leading-relaxed text-muted-foreground">
            Build smarter websites. Sell faster. Scale bigger. The AI-powered platform for
            agencies and entrepreneurs.
          </p>
          <div className="mt-8 space-y-4">
            {['Template to live site in < 60 min', 'AI-generated, SEO-ready content', 'Built-in CRM and client management'].map((item) => (
